...
class AuthBucketOAuth2ServiceProvider implements ServiceProviderInterface
{
    public function register(Application $app)
    {
        ...
        $app['authbucket_oauth2.model'] = [
            ...
            'client' => 'App\\OAuth2Models\\Client',
            'code' => 'App\\OAuth2Models\\Code',
        ...
        $app['authbucket_oauth2.model_manager.factory'] = $app->share(function ($app) {
            return new ModelManagerFactory($app['authbucket_oauth2.model'], $app['matey.db.connection']);
        });
        ...
        $app['authbucket_oauth2.user_provider'] = new \App\MateyModels\OAuth2UserManager($app['matey.db.connection']);
        ...
        $app['authbucket_oauth2.grant_handler'] = [
            ...
            'social_exchange' => 'AuthBucket\\OAuth2\\GrantType\\SocialExchangeGrantTypeHandler'
        ];
